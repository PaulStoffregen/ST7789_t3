...
#define SETCOLOR(c) disp.setTextColor(c, bg ? ST7789_BLACK : c);
...
void tftPrintTest(bool bg)
{
	...
	SETCOLOR(ST7789_YELLOW);
	disp.setTextSize(2);
	disp.println("Hello World!");
	SETCOLOR(ST7789_GREEN);
	disp.setTextSize(3);
	disp.println("Hello World!");
	SETCOLOR(ST7789_BLUE);
	disp.setTextSize(4);
	disp.print(1234.567);

	disp.setCursor(0, 0);
	disp.fillScreen(ST7789_BLACK);
	SETCOLOR(ST7789_WHITE);
	disp.setTextSize(0);
	disp.println("Hello World!");
	disp.setTextSize(1);
	SETCOLOR(ST7789_GREEN);
...
void mediabuttons()
{
	// play
	disp.fillScreen(ST7789_BLACK);
	disp.fillRoundRect(25, 10, 78, 60, 8, ST7789_WHITE);
	disp.fillTriangle(42, 20, 42, 60, 90, 40, ST7789_RED);

	// pause
	disp.fillRoundRect(25, 90, 78, 60, 8, ST7789_WHITE);
	disp.fillRoundRect(39, 98, 20, 45, 5, ST7789_GREEN);
	disp.fillRoundRect(69, 98, 20, 45, 5, ST7789_GREEN);

	// play color
	disp.fillTriangle(42, 20, 42, 60, 90, 40, ST7789_BLUE);

	// pause color
	disp.fillRoundRect(39, 98, 20, 45, 5, ST7789_RED);
	disp.fillRoundRect(69, 98, 20, 45, 5, ST7789_RED);
	// play color
	disp.fillTriangle(42, 20, 42, 60, 90, 40, ST7789_GREEN);
}
...
void setup()
{
  ...
  disp.setAddrWindow(0, 0, 240, 240);
	...
	disp.fillScreen(ST7789_BLACK);
	t[n++] = millis();
	testdrawtext("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur adipiscing ante sed nibh tincidunt feugiat. Maecenas enim massa, fringilla sed malesuada et, malesuada sit amet turpis. Sed porttitor neque ut ante pretium vitae malesuada nunc bibendum. Nullam aliquet ultrices massa eu hendrerit. Ut sed nisi lorem. In vestibulum purus a tortor imperdiet posuere. ", ST7789_WHITE, ST7789_WHITE);
	t[n++] = millis();
	tftPrintTest(false);
	t[n++] = millis();
	testdrawtext("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur adipiscing ante sed nibh tincidunt feugiat. Maecenas enim massa, fringilla sed malesuada et, malesuada sit amet turpis. Sed porttitor neque ut ante pretium vitae malesuada nunc bibendum. Nullam aliquet ultrices massa eu hendrerit. Ut sed nisi lorem. In vestibulum purus a tortor imperdiet posuere. ", ST7789_WHITE, ST7789_BLACK);
	t[n++] = millis();
	tftPrintTest(true);
	t[n++] = millis();
